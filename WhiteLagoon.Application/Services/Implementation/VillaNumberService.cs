...
namespace WhiteLagoon.Application.Services.Implementation
{
    public class VillaNumberService : IVillaNumberService
    {
        ...
        {
            return _unitOfWork.VillaNumber.Any(v => v.Villa_Number == villa_Number);
        }
        ...
        public bool DeleteVillaNumber(int id)
        {
            try
            {
                VillaNumber? objFromDb = _unitOfWork.VillaNumber.Get(vn => vn.Villa_Number == id);
        ...
        {
           return _unitOfWork.VillaNumber.Get(vn => vn.Villa_Number == id , includeProperties: "Villa");
        }
